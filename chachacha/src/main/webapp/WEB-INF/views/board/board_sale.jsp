						...
						<ul class="pagination">
							...
							<c:if test="${page > 1 }">
								<li class="page-item"><a
									href="./BoardSaleList.bo?page=${page-1}" class="page-link">이전&nbsp;</a></li>
							</c:if>
							...
							<c:forEach var="a" begin="${startpage}" end="${endpage}">
								...
								<c:if test="${a!=page}">
									<li class="page-item"><a href="./BoardSaleList.bo?page=${a }"
							...
							<c:if test="${page < maxpage}">
								<li class="page-item"><a
									href="./BoardSaleList.bo?page=${page+1}" class="page-link ">&nbsp;다음</a>
								</li>
							</c:if>
